...
const baseConfig = {
  entry: {
    ...
    "confidential/client/index": "src/confidential/client/index.ts",
    "confidential/server/index": "src/confidential/server/index.ts",
    "confidential/facilitator/index": "src/confidential/facilitator/index.ts",
  },
  dts: {
    resolve: true,
  },
